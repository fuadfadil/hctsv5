...
i want to build Trading platform web app , to healthcare services trading using ICD11 healthcare indexing  system , the trading will be done between healthcare organizations and insurance companies , all healthcare organizations and insurance companies they have their profiles they manage their sales and dashboards and their profiles  and users , the healthcare organization can create packages in bulk with proper calculated discount to sell to the insurance companies , the insurance companies can see the dashboard if there is services for sell , they can chose and pay for it using payment method they prefer , the main page contains two main functions for registration , it can register the healthcare organizations and insurance companies, each company or organization can see their profile and dashboard,
